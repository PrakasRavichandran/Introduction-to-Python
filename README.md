...
*Traditional full stack web frameworks. Also see [RESTful API](https://github.com/PrakasRavichandran/Introduction-to-Python#restful-api).*
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/Prakasravichandran/Introduction-to-Python/blob/master/CONTRIBUTING.md) first.

- - -

If you have any question about this opinionated list, do not hesitate to contact me [@Prakash](https://twitter.com/) on Twitter or open an issue on GitHub.
